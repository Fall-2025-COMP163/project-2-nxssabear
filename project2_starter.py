...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        if crit_chance <= 3:
            damage = (self.strength * 2) * 2  # Critical hit
...
if __name__ == "__main__":
    ...
    warrior = Warrior("Sir Gerald")
    mage = Mage("Makarov")
    rogue = Rogue("Suzaku")
    necromancer = Necromancer("Zeref")
    ...
    necromancer.drain_life(target4)
